...
> **Note:** This server is designed to work in tandem with the [Tavily Client](../tavily-client/README.md). Together, they demonstrate a secure, decoupled microservices architecture for Agentic AI.
